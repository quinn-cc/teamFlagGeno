BZFlag Server Plugin: teamFlagGeno
================================================================================
...
teamFlagGeno directory to a new name, and then manually replace teamFlagGeno
...
To load the plugin with specific settings, use the format:
  -loadplugin teamFlagGeno,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin teamFlagGeno,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin teamFlagGeno,<configfilename>
For example:
  -loadplugin teamFlagGeno,/path/to/my/sampleplugin.cfg
